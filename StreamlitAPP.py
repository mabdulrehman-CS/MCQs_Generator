...
st.markdown("<p style='text-align: center; color: white; font-size: 1.2rem; margin-top: -1rem; margin-bottom: 2rem;'>Powered by LangChain & GroqAI 🤖</p>", unsafe_allow_html=True)
